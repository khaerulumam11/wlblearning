...
package com.wlb.framework.learning.ui.main.timeline.provider;
 ...
 */
@Module
public abstract class MFPostingProvider {
    @ContributesAndroidInjector
    abstract MPostingFragment providepostingFragmentFactory();

    @ContributesAndroidInjector
    abstract MArticleFragment provideArticleFragmentFactory();

    @ContributesAndroidInjector
    abstract MJobsFragment provideJobFragmentFactory();

    @ContributesAndroidInjector
    abstract MCompaniesFragment provideCompaniesFragmentFactory();
