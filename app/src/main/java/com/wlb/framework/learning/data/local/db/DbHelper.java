...
public interface DbHelper {
    ...
    Observable<List<Course>> getAllCourse();
    Observable<List<Course>> getAllCourseById(Long courseId);
    Observable<Boolean> saveCourseList(List<Course> courseList);
    Observable<Boolean> isCourseEmpty();
}
