...
import com.wlb.framework.learning.data.local.Config;
import com.wlb.framework.learning.utils.NotificationUtils;
...
//            Sharepref.saveInt(Constant.NOTIF, notif_count + 1);
    ...
    private void handleDataMessage(Map json) {
        ...
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent resultIntent = new Intent(getApplicationContext(), WlbApp.class);
