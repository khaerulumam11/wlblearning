...
public class LCategoryAdapter1 extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public LCategoryAdapter1(List<CategoryModel.Data> blogResponseList, Context mContext) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                ItemCategoryBinding blogViewBinding = ItemCategoryBinding.inflate(LayoutInflater.from(parent.getContext()),
                        parent, false);
                return new LCategoryAdapter1.ItemListViewHolder(blogViewBinding);
