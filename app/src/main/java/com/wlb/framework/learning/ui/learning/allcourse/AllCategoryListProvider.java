 ...
 */
@Module
public abstract class AllCategoryListProvider {

    @ContributesAndroidInjector(modules = AllCategoryListModule.class)
    abstract AllCategoryActivity provideBlogFragmentFactory();
}
