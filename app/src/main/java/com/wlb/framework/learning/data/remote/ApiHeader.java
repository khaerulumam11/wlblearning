...
public class ApiHeader {
    ...
    private WlbApiHeader mWlbApiHeader;
    ...
    public WlbApiHeader getWlbApiHeader() {
        return mWlbApiHeader;
    }
    ...
    public static final class WlbApiHeader {

        @Expose
        @SerializedName("Authorization")
        private String mAuthorization;

        public WlbApiHeader(String mAuthorization) {
