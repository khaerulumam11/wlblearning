 ...
 */
@Module
public abstract class MFTimelineProvider {

    @ContributesAndroidInjector(modules = MFTimelineModule.class)
    abstract DetailLearningAcitivity providepostingFragmentFactory();
}
