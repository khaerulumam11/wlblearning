...
package com.wlb.framework.learning.data;
...
public class AppDataManager implements DataManager {
    ...
    public Single<LoginResponseWlb> doServerLoginWLBApiCall(LoginRequest.ServerLoginRequest request) {
        return mApiHelper.doServerLoginWLBApiCall(request);
    }

    @Override
    public Single<RegisterResponse> doServerRegisterWLBApiCall(RegisterRequest request) {
        return mApiHelper.doServerRegisterWLBApiCall(request);
    }
    ...
    public String getFirebaseTokenID() {
        return mPreferencesHelper.getFirebaseTokenID();
    }
    ...
    public String getoAuthUsertoken() {
        return mPreferencesHelper.getoAuthUsertoken();
    }

    @Override
    public void setoAuthUsertoken(String oAuthUsertoken) {
        mPreferencesHelper.setoAuthUsertoken(oAuthUsertoken);
    }
    ...
    public Observable<List<Course>> getAllCourse() {
        return mDbHelper.getAllCourse();
    }

    @Override
    public Observable<List<Course>> getAllCourseById(Long courseId) {
        return mDbHelper.getAllCourseById(courseId);
    }

    @Override
    public Observable<Boolean> saveCourseList(List<Course> courseList) {
        return mDbHelper.saveCourseList(courseList);
    }

    @Override
    public Observable<Boolean> isCourseEmpty() {
        return mDbHelper.isCourseEmpty();
    }
    ...
    @Override
    public void updateUserWlbInformation(LoggedInMode loggedInMode, String id, String name, String email, String socialLinks, String biography, String roles, int latestBalance, String dateAdded, String lastModified, int saltRounds, String token, String oauth) {
        setAccessToken(token);
        setCurrentUserLoggedInMode(loggedInMode);
        setCurrentUserEmail(email);
        setCurrentUserName(name);
        setoAuthUsertoken(oauth);
    }
}
